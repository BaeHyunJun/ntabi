...
//	iMinUndoInterval : 50,
	...
	$init : function(iframe){
		...
		this.sBlankPageURL = "smart_editor2_inputarea";
		this.sBlankPageURL_EmulateIE7 = "smart_editor2_inputarea_ie8";
	...
	initIframe : function(){
		try {
			...
			if (sCSSBaseURI){
				...
				linkNode.href = '/Content/smart_editor2_in.css';
...
nhn.husky.SE2B_CSSLoader = jindo.$Class({
	...
	*/
	...
	loadSE2CSS : function(sMsg, oArgs){
		...
		nhn.husky.SE2M_Utils.loadCSS("/Content/smart_editor2_items.css", fnCallback);
