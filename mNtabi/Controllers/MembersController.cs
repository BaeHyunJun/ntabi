...
namespace mNtabi.Controllers
{
    public class MembersController : Controller
    {
        ...
        public ActionResult join()
        {
            ...
            return Redirect("/Members/join2" + path);
        }
        ...
        // GET: Members/join2
        public ActionResult join2(string key)
        {
        ...
        // GET: Members/join3
        public ActionResult join3(FormCollection f)
        {
        ...
        // GET: Members/join2
        public ActionResult find2(string name, string email)
        {
            ...
            return Content("<script>alert('해당정보와 일치하는 아이디가 존재하지 않습니다.'); location.href='/Members/find1';</script>");
            //return View();
        }

        // GET: Members/join3
        public ActionResult find3(string id, string name, string email)
        {
            string txt = "";
            ...
            if (chkID.Any())
            {
                ...
                _body = " <div style='text-align: center;'>" +
                            ...
                            "</p>" +
                            "<h1 style='margin:40px; font-size: 30px;'>임시비밀번호 재설정 인증안내</h1>" +
                            "<h4 style='font-weight: normal;'>" +
                                "본 이메일의 본인인증 확인을 통해 비밀번호를 재설정 하실 수 있습니다.<br/>" +
                                "비밀번호 재설정을 위해 아래 링크를 클릭해주세요." +
                            "</h4>" +
                            "<h4 style='margin:10px; font-weight: normal;color:red;' >※ 본 메일은 발신전용 메일로 회신되지 않습니다. 문의사항이 있으시면 엔타비 <b><a href='" + domain + "/Community/Lists?type=qna' style='text-decoration: none; color: #0e0e0e;'>고객센터</a></b> 로 문의해 주세요.</h4>" +
                            "<center style='margin: 50px;'>" +
                                "<p style='width:800px; padding:10px; background-color: #8acb20; color: #fff;'>" +
                                    "<a href='" + domain + "/Members/Join?key=" + authStr + "' style='text-decoration: none; color: #fff;'>이메일 인증하기</a>" +
                                "</p>" +
                            "</center>" +
                            "<div>" +
                                "<hr width='800px;'>" +
                ...
                if (System.Text.RegularExpressions.Regex.IsMatch(email, pattern))
                {
                    ...
                    else
                    {
                        ...
                        _body = " <div style='text-align: center;'>" +
                                    ...
                                    "</p>" +
                                    "<h1 style='margin:30px; font-size: 25px;'>엔타비 회원가입 신청을 해주셔서 감사합니다</h1>" +
                                    "<h4 style='font-weight: normal;'>" +
                                        "이메일 주소 확인을 통한 회원 가입 승인 후 엔타비의 다양한 서비스를 이용하실 수 있습니다.<br/>" +
                                        "가입 승인을 위해 아래 링크를 클릭하시면, 이메일 인증이 확인되며, 엔타비 회원가입이 완료 됩니다." +
                                    "</h4>" +
                                    "<h4 style='margin:10px; font-weight: normal;color:red;' >※ 본 메일은 발신전용 메일로 회신되지 않습니다. 문의사항이 있으시면 엔트레블스 <b><a  style='text-decoration: none; color: #0e0e0e;' href='" + domain + "/Community/Lists?type=qna'>고객센터</a></b> 로 문의해 주세요.</h4>" +
                                    "<center style='margin: 50px;'>" +
                                        "<p style='width:800px; padding:10px; background-color: #8acb20; color: #fff;'>" +
                                            "<a href='" + domain + "/Members/Join?key=" + authStr + "' style='text-decoration: none; color: #fff;'>이메일 인증하기</a>" +
                                        "</p>" +
        ...
        public ActionResult naverLogin()
        {
            ...
            string redirect_uri = "http://" + host + "/Members/CallbackNaver";
