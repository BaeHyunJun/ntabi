...
namespace mNtabi.Controllers
{
    public class EventController : Controller
    {
        ...
        // GET: Event
        public ActionResult Index(string t = "event", int p = 1)
        {
        ...
        public ActionResult Views(string t = "event", int k = 0)
        {
            ...
            var data = (from a in board
                        ...
                        .ToList()
                        .GroupBy(g => new { g.post_type, g.post_ID, g.post_title, g.ist_date, g.post_status, g.name, g.post_content, g.post_mContent, g.PDT_IST_EMP_NO, g.PDT_TYPE_CODE, g.PDT_SEQ, g.PDT_YY, g.CU_SEQ, g.CU_YY, g.post_category })
                        .ToList()
                        .Select(s => new
                        {
