    ...
    public class RecommendController : Controller
    {
        ...
        public ActionResult Index(int p = 1)
        {
            var board = DB.NT_Board_2.Where(w => w.CORP_CODE.Equals(corp_code))
                                     .Where(w => w.post_type.Equals("recommend"))
        ...
        // GET: Recommend/Views
        public ActionResult Views(int k = 0)
        {
        ...
        public JsonResult JSON_Update(string key, string content, string cat = "")
        {
            ...
            var boardData = from bf in DB.NT_Board_2
                            where bf.post_type == "recommend" && corp_code == bf.CORP_CODE
